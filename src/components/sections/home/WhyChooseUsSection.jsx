...
/**
 * WhyChooseUsSection Component ("Why Choose Us - More Than Spaces, A Partner in Your Growth")
 *
 * Features:
 * - 100% Global Theme tokens (No custom hex codes)
 * - Zero SVG tags (Pure FontAwesome WebFont icons)
 * - Exact replica of the reference UI/UX design
 * - 4 Pillars: Prime Locations, Wide Range of Options, Expert Guidance, Verified & Trusted
 * - Clean vertical dividers on desktop with smooth hover micro-animations
 * - Fully responsive for all device screens (Mobile, Tablet, Desktop)
 */
        ...
        >
          {features.map((feature, idx) => {
            ...
            return (
              ...
              >
                {/* Circular Icon Container with Luxury Micro-Animation */}
                ...
                {/* Feature Title (Compact & Guaranteed Single Line) */}
