    ...
    <footer className="relative w-full bg-[var(--footer-bg)] text-[var(--text-light)] overflow-hidden border-t border-[var(--footer-border)] font-sans">
      ...
      <Container className="relative z-10">
        ...
        <div className="pt-12 pb-9 flex flex-wrap lg:flex-nowrap gap-y-10 lg:gap-0">
          {/* Column 1: Brand & Bio (Mobile: full width, Desktop: 22% width, with vertical right divider) */}
          <div className="w-full lg:w-[22%] lg:pr-6 lg:border-r border-[var(--footer-border)] space-y-4">
            ...
            {/* Social Icons (FontAwesome <i> tags, ZERO SVG with premium micro-lift) */}
          ...
          {/* Links Section: 2 Columns on Mobile, 3 Columns on Tablet, lg:contents on Desktop (100% Untouched on Desktop) */}
          <div className="w-full lg:contents grid grid-cols-2 sm:grid-cols-3 gap-y-8 gap-x-6 sm:gap-x-8 lg:gap-0">
            {/* Column 2: Quick Links (Mobile: col 1 of 2, Desktop: 14% width) */}
            ...
            {/* Column 3: Office Spaces (Mobile: col 2 of 2, Desktop: 15.5% width) */}
            ...
            {/* Column 4: Popular Sectors (Mobile: spans 2 cols with 2-col sector grid, Desktop: 16.5% width) */}
          ...
          {/* Column 5: Stay Updated (Mobile: full width, Desktop: 32% width with right skyline) */}
          <div className="w-full lg:w-[32%] lg:pl-8 space-y-3.5 relative z-10 pt-2 lg:pt-0">
            ...
            {/* Subscribe Form (Working Dummy with subtle glow focus) */}
        ...
        {/* Bottom Bar: Copyright, Policies & Back to Top (Compact & Fully Responsive) */}
        <div className="py-4.5 border-t border-[var(--footer-border)] text-xs text-[var(--text-light-muted)] flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 order-3">
            ...
            {/* Back to Top with Gold Circle Border Matching Reference UI */}
            <button
              onClick={scrollToTop}
              type="button"
